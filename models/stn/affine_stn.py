...
class AffineSTN(nn.Module):
    ...
    def get_grid(self, img_a, img_b):
        ...
        resampling_grid = F.affine_grid(theta.view(-1, 2, 3), img_a.size()) #align_corners=True
    ...
    def forward(self, img_a, img_b, apply_on=None):
        ...
        warped_images = []
        for img in apply_on:
            resampling_grid = F.affine_grid(theta.view(-1, 2, 3), img.size()) ##,align_corners=None
